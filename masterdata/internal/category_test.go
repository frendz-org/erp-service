...
func setupCategoryTest() (*usecase, *MockCategoryRepository, *MockItemRepository, *MockMasterdataCache) {
...
func TestCategoryList_Success(t *testing.T) {
	...
	req := &masterdatadto.ListCategoriesRequest{
		Page:    1,
		PerPage: 10,
	}
	...
	categoryRepo.On("List", ctx, mock.AnythingOfType("*contract.CategoryFilter")).
...
func TestCategoryList_CacheHit(t *testing.T) {
	...
	cachedResponse := &masterdatadto.ListCategoriesResponse{
		Categories: []*masterdatadto.CategoryResponse{
			{ID: uuid.New(), Code: "CACHED", Name: "Cached Category"},
		},
		Pagination: masterdatadto.Pagination{Total: 1, Page: 1, PerPage: 10},
	}
...
func TestCategoryCreate_Success(t *testing.T) {
	...
	req := &masterdatadto.CreateCategoryRequest{
		Code:        "NATIONALITY",
		Name:        "Nationality",
...
func TestCategoryUpdate_Success(t *testing.T) {
	...
	newName := "Gender Type"
	req := &masterdatadto.UpdateCategoryRequest{
		Name:    &newName,
		Version: 1,
	}
...
func TestNormalizePageParams(t *testing.T) {
	tests := []struct {
		...
		{"zero perPage", 1, 0, 1, 20},
		{"negative perPage", 1, -1, 1, 20},
		{"perPage over max", 1, 150, 1, 100},
		{"both invalid", 0, 0, 1, 20},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			page, perPage := normalizePageParams(tt.inputPage, tt.inputPerPage)
