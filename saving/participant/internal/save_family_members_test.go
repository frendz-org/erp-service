...
func makeFamilyMemberUsecase() (*usecase, *MockTransactionManager, *MockParticipantRepository, *MockParticipantFamilyMemberRepository, *MockFileRepository) {
...
func TestSaveFamilyMembers_EmptySlice_ReturnsBadRequest(t *testing.T) {
	...
	req := &participantdto.SaveFamilyMembersRequest{
		TenantID:      tenantID,
		ProductID:     productID,
		ParticipantID: participantID,
		FamilyMembers: []participantdto.FamilyMemberItem{},
	}
...
func TestSaveFamilyMembers_ParticipantNotFound(t *testing.T) {
	...
	req := &participantdto.SaveFamilyMembersRequest{
		...
		ProductID:     productID,
		ParticipantID: participantID,
		FamilyMembers: []participantdto.FamilyMemberItem{{FullName: "John", RelationshipType: "CHILD"}},
	}
...
func TestSaveFamilyMembers_StepMarkedComplete(t *testing.T) {
	...
	req := &participantdto.SaveFamilyMembersRequest{
		...
		ParticipantID: participantID,
		UserID:        userID,
		FamilyMembers: []participantdto.FamilyMemberItem{{FullName: "Jane", RelationshipType: "PARENT"}},
	}
