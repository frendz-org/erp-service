...
func (uc *usecase) SavePension(ctx context.Context, req *participantdto.SavePensionRequest) (*participantdto.PensionResponse, error) {
	var result *participantdto.PensionResponse
