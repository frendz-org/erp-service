...
func (uc *usecase) SaveBeneficiaries(ctx context.Context, req *participantdto.SaveBeneficiariesRequest) ([]participantdto.BeneficiaryResponse, error) {
	...
	err := uc.txManager.WithTransaction(ctx, func(txCtx context.Context) error {
		...
		result = make([]participantdto.BeneficiaryResponse, 0, len(insertedBeneficiaries))
