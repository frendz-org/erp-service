...
func validateSelfRegisterRequest(req *participantdto.SelfRegisterRequest) []apperrors.FieldError {
...
func (uc *usecase) SelfRegister(ctx context.Context, req *participantdto.SelfRegisterRequest) (*participantdto.SelfRegisterResponse, error) {
...
func (uc *usecase) linkExistingParticipantToUser(
	...
	err := uc.txManager.WithTransaction(ctx, func(txCtx context.Context) error {
		...
		result = &participantdto.SelfRegisterResponse{
			IsLinked:           true,
