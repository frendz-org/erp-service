...
func TestValidateParticipantOwnership(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := participant.ValidateParticipantOwnership(tt.participant, tt.tenantID, tt.productID)
...
func TestValidateEditableState(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := participant.ValidateEditableState(tt.participant)
...
func TestSanitizeFieldName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := participant.SanitizeFieldName(tt.fieldName)
...
func TestSanitizeFilename(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := participant.SanitizeFilename(tt.filename)
			assert.Equal(t, tt.want, got)
		})
	}
}
...
func TestGenerateObjectKey(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := participant.GenerateObjectKey(tt.tenantID, tt.productID, tt.participantID, tt.fieldName, tt.filename)
...
func TestBuildStepsCompleted_NilMap_ReturnsAllFalse(t *testing.T) {
	result := participant.BuildStepsCompleted(nil)
	assert.Equal(t, participant.StepsCompleted{}, result)
...
func TestBuildStepsCompleted_PartialMap(t *testing.T) {
	...
	result := participant.BuildStepsCompleted(m)
