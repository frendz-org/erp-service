...
func setupItemTest() (masterdata.Usecase, *MockCategoryRepository, *MockItemRepository, *MockMasterdataCache) {
...
func TestItemList_Success(t *testing.T) {
	...
	categoryID := uuid.New()
	req := &masterdata.ListItemsRequest{
	...
	itemRepo.On("List", ctx, mock.AnythingOfType("*masterdata.ItemFilter")).
...
func TestItemCreate_Success(t *testing.T) {
	...
	req := &masterdata.CreateItemRequest{
		CategoryID: categoryID,
		Code:       "MALE",
		Name:       "Male",
	}
...
func TestItemUpdate_Success(t *testing.T) {
	...
	newName := "Male Gender"
	req := &masterdata.UpdateItemRequest{
		Name:    &newName,
		Version: 1,
	}
...
func TestItemValidateCode_Success(t *testing.T) {
	...
	req := &masterdata.ValidateCodeRequest{
		CategoryCode: "GENDER",
		ItemCode:     "MALE",
	}
...
func TestItemValidateCodes_AllValid(t *testing.T) {
	...
	req := &masterdata.ValidateCodesRequest{
