...
func (uc *usecase) CompleteProfileRegistration(
	ctx context.Context,
	req *CompleteProfileRegistrationRequest,
) (*CompleteProfileRegistrationResponse, error) {
	...
	response := &CompleteProfileRegistrationResponse{
		UserID:  user.ID,
		Email:   session.Email,
...
func (uc *usecase) validateProfileFields(ctx context.Context, req *CompleteProfileRegistrationRequest) error {
